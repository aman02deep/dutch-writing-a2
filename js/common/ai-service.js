...
Reply JSON ONLY: {"isValid":boolean,"feedback":"HTML string with <b> tags"}
    ...
    /**
     * Gets a subtle hint for a verb conjugation (V2 Quiz)
     */
    ...
    /**
     * Explains why a specific verb conjugation is wrong (V2 Quiz)
     */
    async explainVerbError(verb, tense, userAnswer, correctAnswer, sentence) {
        try {
            ...
            - Feedback: "Good sentence! However, you used '[UserVerb]' (meaning '...'), but we are practicing '[TargetVerb]'. Please try again with '[TargetVerb]'."

            Scenario B: The student made a mistake (grammar/spelling).
            - Feedback: Identify the mistake (wrong stem, ending, etc.) and explain the rule. If the user's word exists, briefly mention its meaning to clear up confusion.
            
            Keep it encouraging, educational, and short (max 3 lines).
            `.trim();
